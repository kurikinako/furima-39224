...
RSpec.describe OrderAddress, type: :model do
  describe '購入情報の保存' do
    ...
    context '内容に問題がある場合' do
      ...
      it 'sender_idを選択していないと保存できない' do
      ...
      it 'tel_numberが10桁未満だと保存できない' do
      ...
      it 'tel_numberが12桁以上だと保存できない' do
        @order_address.tel_number = '123456789123'
        @order_address.valid?
        expect(@order_address.errors.full_messages).to include('Tel number is invalid')
      end
      it 'tel_numberが全角数値では保存できない' do
